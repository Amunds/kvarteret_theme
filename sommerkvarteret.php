...
<div id="content" role="main">
    <div id="left_content">
        <?php
        global $post;
        $featured = get_posts('numberposts=1&category_name=sk');
        $current_news = get_posts('numberposts=10&category_name=sk&offset=1');
        ?>
        ...
        <?php foreach($current_news as $post): setup_postdata($post); ?>
